                    ...
                    try {
                        ...
                        if (linesToSplit.length == 4) {
                            ...
                            /*if (field01.checkPole(co1i, co1j) && field01.checkPole(co2i, co2j) &&
                                ...
                                field01.newList(co1i, co1j, co2i, co2j, co3i, co3j, co4i, co4j);
                            ...
                            ArrayList<Integer[]> listPeredacha = new ArrayList<>();
                            listPeredacha.add(new Integer[]{co1i, co1j});
                            listPeredacha.add(new Integer[]{co2i, co2j});
                            listPeredacha.add(new Integer[]{co3i, co3j});
                            listPeredacha.add(new Integer[]{co4i, co4j});

                            if (field01.drawPoleAndTwoDecks(listPeredacha)){
                                break;
                            } else {
                                System.out.println("Вы пытаетесь разместить корабль на месте уже существующего");
                                continue;
                ...
                while (true) {
                    ...
                    try {
                        ...
                        if (linesToSplit.length == 4) {
                            ...
                            if (field02.drawPoleAndTwoDecks(listPeredacha)){
                                break;
                            } else {
                                System.out.println("Вы пытаетесь разместить корабль на месте уже существующего");
                                continue;
